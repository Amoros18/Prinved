package com.example.prinved.ui.home
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "En caisse: ${item.caisse}",
                    style = MaterialTheme.typography.titleMedium
                )
            }
            Text(
                text = "Dans OM: ${item.orange_money}",
                style = MaterialTheme.typography.titleMedium
            )
            Text(
                text = "Depense: ${item.depense}",
                style = MaterialTheme.typography.titleMedium
            )
            Text(
                text = "Vente OM: ${item.vente_om}",
                style = MaterialTheme.typography.titleMedium
            )
            Text(
                text = "ID: ${item.id}",
...
fun HomeBodyPreview() {
    InventoryTheme {
        HomeBody(listOf(
            Item(1,"date 1", 9000, 2000, 4000, 2023,700,900,830,982,799),
            Item(2,"date 1", 9000, 2000, 4000, 2023,700,900,830,982,799),
            Item(3,"date 1", 9000, 2000, 4000, 2023,700,900,830,982,799)
        ), onItemClick = {})
    }
}
